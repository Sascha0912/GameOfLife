 ...
 * Zeichenblatt
 *
 * Einfache Java-Klasse zum Zeichnen einfacher Grafikelemente Enthaelt auch
 * Turtle-Funktionalitaet
 *
...
public class Zeichenblatt
{
	 ...
	 * 
	 * @param xmin
	 *            minimale x-Koordinate des Benutzerkoordinatensystems
	 * @param ymin
	 *            minimale y-Koordinate des Benutzerkoordinatensystems
	 * @param xmax
	 *            maximale x-Koordinate des Benutzerkoordinatensystems
	 * @param ymax
	 *            maximale y-Koordinate des Benutzerkoordinatensystems
	 */
	...
	{
		return breite * (x - xmin) / (xmax - xmin);
	}

	private double mapY(double y)
	{
		return hoehe * (ymax - y) / (ymax - ymin);
	}
	...
	/**
	 * Hintergrundfarbe setzen (wird erst nach naechstem Loeschen des Bildes
	 * aktiv)
	 * 
	 * @param farbe
	 *            Hintergrundfarbe
	 ...
	 *            y-Koordinate des Punktes
	 * @param durchmesser
	 *            Durcmesser des Punktes in Pixeln
	 */
	 ...
	 * 
	 * @param x
	 *            x-Koordinate des Referenzpunkts (untere linke Ecke)
	 * @param y
	 *            y-Koordinate des Referenzpunkts (untere linke Ecke)
	 * @param weite
	 *            Ausdehnung in x-Richtung
	 * @param hoehe
	 *            Ausdehnung in y-Richtung
	 ...
	 * 
	 * @param bildname
	 *            Dateiname eines Bildes (gif, jpeg, png,...)
	 */
	 ...
	 *            Dateiname eines Bildes (gif, jpeg, png,...)
	 * @param x
	 *            x-Koordinate des Bildzentrums
	 * @param y
	 *            y-Koordinate des Bildzentrums
	 * @param weite
	 *            Weite des Bildes
	 * @param hoehe
	 *            Hoehe des Bildes
	 ...
	 *            Dateiname eines Bildes (gif, jpeg, png,...)
	 * @param x
	 *            x-Koordinate der Bildmitte
	 * @param y
	 *            y-Koordinate der Bildmitte
	 */
	 ...
	 * 
	 * @param x
	 *            x-Koordinate neue Position
	 * @param y
	 *            y-Koordinate neue Position
	 */
	 ...
	 * 
	 * @param schritte
	 *            Anzahl Schritte in aktueller Bewegungsrichtung
	 */
	 ...
	 * 
	 * @param winkel
	 *            Drehwinkelanderung entgegen dem Uhrzeigersinn
	 */
